    ...
    >
      <div className="flex items-center justify-between mb-6">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="flex items-center gap-1 text-purple-600 hover:text-purple-700 font-medium px-4 py-2 rounded-lg hover:bg-purple-50 transition-colors"
        >
          View All
        ...
        <div className="flex gap-4 overflow-x-auto no-scrollbar py-2 px-6">
          {categories.map((category, index) => (
            <motion.button
              ...
              className="flex-shrink-0 px-6 py-3 bg-white rounded-xl text-sm whitespace-nowrap shadow-sm hover:shadow-md transition-shadow border border-gray-100 hover:bg-purple-50 hover:border-purple-200"
            >
              {category}
            </motion.button>
          ))}
