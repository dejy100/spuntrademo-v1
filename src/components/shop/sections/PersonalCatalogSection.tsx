    ...
    <section>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600">Find the best deals across multiple luxury retailers</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 overflow-y-auto max-h-[400px] scrollbar-hide">
          {brands.map((brand) => (
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-md overflow-hidden p-6 hover:shadow-lg transition-all"
            >
              <img
                src={brand.logo}
                alt={brand.name}
